...
def get_access_token():
    response = requests.get(
        "https://oauth.vk.com/authorize?client_id=8163455&display=page&redirect_uri=https://oauth.vk.com/blank.html&scope=friends,stories,photos,app_widget,groups,docs,manage,wall&response_type=token&v=5.131&state=123456"
    )
